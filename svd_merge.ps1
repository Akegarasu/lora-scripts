...
$save_precision = "bf16" # precision in saving, default float | 保存精度, 可选 float、fp16、bf16, 默认 和源文件相同
...
$models = "./output/qinglongmeiyandan.safetensors ./output/meiyandan_origin-000008.safetensors" # original LoRA model path need to resize, save as cpkt or safetensors | 需要合并的模型路径, 保存格式 cpkt 或 safetensors，多个用空格隔开
